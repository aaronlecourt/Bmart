...
<div class="px-0 mb-2" style="font-weight:600">
    <form action="{{ route('vendor.sales') }}" method="GET" class="w-100">
        @csrf
    <div class="row p-3 w-100 d-flex justify-content-between align-items-end">
            ...
            <div class="col-md-1">
                <button class="btn btn-secondary w-100 mt-1" type="submit" style="font-weight:600">Apply Filters</button>
            </div>
            <div class="col-md-1">
            ...
            <div class="col-md-2">
                <button class="btn btn-primary w-100 mt-1" id="generateReportBtn" type="button" style="font-weight:600">Generate Report</button>            
            </div>
        </form>
    </div>
...
$(document).ready(function() {
  ...
  $('#generateReportBtn').click(function() {
    ...
    var reportContent = '<html><head><title>Sales Report</title></head><body><table>';
    ...
    for (var i = 0; i < table.rows.length; i++) {
      ...
      for (var j = 0; j < table.rows[i].cells.length; j++) {
        reportContent += '<td>' + table.rows[i].cells[j].innerText + '</td>';
      }
    ...
    // Append the report content to the new window
